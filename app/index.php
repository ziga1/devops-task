...
<head>
  ...
  <!-- ✅ ENV-driven title goes here, inside <head> -->
  <title><?= htmlspecialchars($appTitle, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></title>
...
<body>
    ...
    <p id="env-title" class="text-muted">App title from ENV: <?= htmlspecialchars($appTitle, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></p>
    </div>
    <div class="col-sm-6">
    <?php if (!$is_admin) { ?>
        <ol class="breadcrumb">
